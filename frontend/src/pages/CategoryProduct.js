...
const CategoryProduct = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="hidden md:grid grid-cols-[200px,1fr] gap-12">
                {/* left side */}

                <div className="bg-white px-4 py-3 min-h-[calc(100vh-120px)] w-64 overflow-y-scroll scrollbar-hide shadow-xl">
