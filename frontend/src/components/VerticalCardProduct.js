    ...
    return (
        <div className='md:container mx-auto my-6 relative'>
            ...
            <div className="md:px-0 px-3">
                ...
                <div className="flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-hide transition-all" ref={scrollElemet}>
...

                    {
                        loading ? (
                            ...
                            data.map((item, index) => {
                                return (
                                    <Link to={"product/" + item?._id} className="w-full min-w[280px] md:min-w-[320px] max-w[280px] md:max-w-[320px] bg-white rounded-sm shadow">
